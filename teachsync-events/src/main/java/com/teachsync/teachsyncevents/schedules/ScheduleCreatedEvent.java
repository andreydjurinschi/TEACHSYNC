...
public class ScheduleCreatedEvent extends BaseEvent {
    ...
    public ScheduleCreatedEvent(Long scheduleId, Long teacherId, Long groupCourseId,
                                String courseName, String groupName, String classRoomName,
                                LocalTime startTime, LocalTime endTime, Set<String> weekDays) {
        super("schedule-service", ActionTypes.SCHEDULE_CREATED);
